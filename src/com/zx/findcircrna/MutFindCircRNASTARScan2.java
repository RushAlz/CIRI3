...
public class MutFindCircRNASTARScan2 extends FindCircRNASTARScan2{
	public MutFindCircRNASTARScan2(int minMapqUni, HashMap<String, Integer> circFSJMap, int linear_range_size_min,
